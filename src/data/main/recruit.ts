import { Recruit } from '../../config/types';
...
勤続年数5年から10年のスタッフも多く、学生さんも4年間勤めてくれることが多いです。
一人に負担が集中せずにみんなと分け合って仕事を進めています。
また、製造社員スタッフは「オペレーションリーダー」「カスタマーリーダー」など一人ずつ役割を分けています。
それぞれに成長できる環境です。
定期的に担当ポジションのローテーションもあるので、パン製造の全行程・全レシピを習得できる他、パン製造や店舗の運営だけでなく、カフェ業務まで学べます。
販売やカフェの仕事も。
一日体験入社制度もありますので、どうぞお問合せください。


セクションマネージャーや店長へのキャリアステップも可能です。
    `,
  messages: [
    {
      title: '1. 挑戦を応援します',
