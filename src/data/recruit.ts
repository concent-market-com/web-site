...
また「パン作りやカフェ、接客に興味はあるけど社員で挑戦する自信はないかも」という方にも、アルバイトパートから社員登用制度もあります。
現在スタッフは40名ですが、半年に一度の面談を通し個人個人の「やりたい！」を実現しています。

パン作りに興味がある、人と話すことが好き、お客様に喜んでいただくことが好き、そんな方々と一緒に働けることを楽しみにしています。
本格的にパン作りを習得したい。でも社員で働けるかどうか不安…。という方にも色々な制度を設けてますので、
年齢関係なく「ちょっと気になるなぁ」という方は、お気軽にお問合せください。
  ...
  recruit: [
    ...
    },
    {
      ...
      items: [
        ...
        { key: '給与', value: '月給 経験者230,000円から(未経験の方は216,000円〜随時昇給)
          （チーフ/25万円～30万円  店長/30万円～40万円）' },
        {
          key: '休日',
